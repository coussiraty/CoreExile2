...
namespace Radar
{
    ...
    {
        /// <summary>
        /// The host overlay service, injected once by the plugin on enable.
        /// Used to upload/resolve icon sprite textures.
        /// </summary>
        internal static IOverlayService Overlay = null!;
        ...
        public void ShowSettingWidget()
        {
            ...
            IconPicker.Overlay.AddOrGetImage(this.FilePathName, out var p, out var w, out var h);
        ...
        {
            IconPicker.Overlay.AddOrGetImage(this.FilePathName, out var p, out var width, out var height);

    ...
    public class Config
    {
        ...
        public void Draw(bool isSelf = false, TextureLoader textures = null, bool useGradientGlobal = false)
        {
            ...
            if (ImGui.BeginTable("config_table", 2))
            {
                ...
                ExileBridge.Draw.Vector2SliderInt("Shift (x, y)", ImGui.GetColumnWidth(), ref this.Shift, -4000, 4000, -2500, 2500, ImGuiSliderFlags.Logarithmic);
                ...
                {
                    ExileBridge.Draw.Vector2SliderInt("ES Scale (x, y)", ImGui.GetColumnWidth(), ref this.ESScale, MinBarScaleX, MaxBarScaleX, MinBarScaleY, MaxBarScaleY, ImGuiSliderFlags.Logarithmic);
                }
                ...
                if (isSelf && this.UseIndividualBarScale)
                {
                    if (ExileBridge.Draw.Vector2SliderInt("Health Scale (x, y)", ImGui.GetColumnWidth(), ref this.HealthScale, MinBarScaleX, MaxBarScaleX, MinBarScaleY, MaxBarScaleY, ImGuiSliderFlags.Logarithmic))
                    {
                        this.UpdateGrauationsLocationData();
                    }
                }
                ...
                {
                    if (ExileBridge.Draw.Vector2SliderInt("Scale (x, y)", ImGui.GetColumnWidth(), ref this.Scale, MinBarScaleX, MaxBarScaleX, MinBarScaleY, MaxBarScaleY, ImGuiSliderFlags.Logarithmic))
                    {
                        this.UpdateGrauationsLocationData();
                    }
                }

                ExileBridge.Draw.ToolTip("By default texture is of height 16, " +
                ...
                if (isSelf && this.UseIndividualBarScale)
                {
                    ExileBridge.Draw.Vector2SliderInt("Mana Scale (x, y)", ImGui.GetColumnWidth(), ref this.ManaScale, MinBarScaleX, MaxBarScaleX, MinBarScaleY, MaxBarScaleY, ImGuiSliderFlags.Logarithmic);
                }
                ...
                ExileBridge.Draw.ToolTip("Graduation thickness depends on Font size. Also, Gradation marks are expensive to draw.");
                ImGui.TableNextColumn();
            ...
            if (this.UseCircleDot)
            {
                ...
                if (bgR > 0f)
                {
                    dl2.AddCircleFilled(center, bgR, ExileBridge.Draw.Color(this.CircleBackgroundColor));
                }
                // Main circle background
                dl2.AddCircleFilled(center, r, ExileBridge.Draw.Color(this.BackgroundColor));
                ...
                if (showHealth)
                {
                    ...
                    dl2.PathFillConvex(ExileBridge.Draw.Color(this.HealthbarColor));
                }
                ...
                if (showES)
                {
                    ...
                    dl2.PathStroke(ExileBridge.Draw.Color(this.ESColor), ImDrawFlags.None, arcThick);
                }
                ...
                if (showMana)
                {
                    ...
                    dl2.PathClear();
                    dl2.PathArcTo(center, rArc, start, start + angle, 32);
                    dl2.PathStroke(ExileBridge.Draw.Color(this.ManaColor), ImDrawFlags.None, arcThick);
                }
                ...
                if (this.ShowText)
                {
                    ...
                    {
                        dl2.AddRectFilled(bgTopLeft, bgBottomRight, ExileBridge.Draw.Color(this.TextBackgroundColor));
                    }
                    dl2.AddText(drawPos, ExileBridge.Draw.Color(this.TextColor), tText);
                }
            ...
            float coreHeight = showHealth ? baseScale.Y : 0f;
            float extra = (!showHealth ? ((showES ? esScale.Y : 0f) + (showMana ? manaScale.Y : 0f)) : 0f);
            float previewHeight = above + coreHeight + below + extra + 8f;
            ...
            if (showHealth)
            {
                dl.AddRectFilled(hStart, hEnd, ExileBridge.Draw.Color(this.BackgroundColor));
                if (useGradient && textures != null)
                {
                    var (hb, _, _) = textures.GetTexture("full_bar.png");
                    dl.AddImage(hb, hStart, hStart + new Vector2(baseScale.X * (hPct / 100f), baseScale.Y), Vector2.Zero, Vector2.One, ExileBridge.Draw.Color(this.HealthbarColor));
                }
                else
                {
                    dl.AddRectFilled(hStart, hStart + new Vector2(baseScale.X * (hPct / 100f), baseScale.Y), ExileBridge.Draw.Color(this.HealthbarColor));
                }
            ...
            if (showES)
            {
                ...
                if (useGradient && textures != null)
                {
                    ...
                    dl.AddImage(esTex, esPreviewStart, esPreviewStart + new Vector2(esScale.X * (esPct / 100f), esScale.Y), Vector2.Zero, Vector2.One, ExileBridge.Draw.Color(this.ESColor));
                }
                else
                {
                    dl.AddRectFilled(esPreviewStart, esPreviewStart + new Vector2(esScale.X * (esPct / 100f), esScale.Y), ExileBridge.Draw.Color(this.ESColor));
                }
            ...
            if (showMana)
            {
                ...
                if (useGradient && textures != null)
                {
                    ...
                    dl.AddImage(manaTex, mStart, mStart + new Vector2(manaScale.X * (mPct / 100f), manaScale.Y), Vector2.Zero, Vector2.One, ExileBridge.Draw.Color(this.ManaColor));
                }
                else
                {
                    dl.AddRectFilled(mStart, mStart + new Vector2(manaScale.X * (mPct / 100f), manaScale.Y), ExileBridge.Draw.Color(this.ManaColor));
                }
            ...
            if (this.ShowText)
            {
                ...
                if (this.ShowTextBackground)
                {
                    dl.AddRectFilled(bgTopLeft, bgBottomRight, ExileBridge.Draw.Color(this.TextBackgroundColor));
                }
                dl.AddText(textPos, ExileBridge.Draw.Color(this.TextColor), tText);
            }

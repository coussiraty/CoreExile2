    ...
    public class Config
    {
        ...
        public void Draw()
        {
            ...
            if (ImGui.BeginTable("config_table", 2))
            {
                ...
                ImGui.TableNextColumn();
                if (ExileBridge.Draw.Vector2SliderInt("Scale (x, y)", ImGui.GetColumnWidth(), ref this.Scale, 160, 500, 16, 128, ImGuiSliderFlags.Logarithmic))
                {
                    this.UpdateGrauationsLocationData();
                }
                ...
                ExileBridge.Draw.ToolTip("Graduation thickness depends on Font size. Also, " +
